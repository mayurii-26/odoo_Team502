...
function LoginForm() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    setTimeout(() => { setLoading(false); setError('Invalid email or password.') }, 1000)
  }
  ...
  return (
    <form className={styles.form} onSubmit={handleSubmit} noValidate>
      ...
      {/* Two-column row — matches wireframe Email | Password */}
      ...
      <div className={styles.actions}>
        ...
        <button id="btn-forgot" type="button" className={styles.btnGhost}>
          Forgot Password?
        </button>
      </div>

      {/* Amber info box — matches wireframe */}
...
function SignupForm() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true)
    // TODO: POST /api/v1/auth/register/customer
    ...
    <form className={styles.form} onSubmit={handleSubmit} noValidate>
      ...
      <div className={styles.row}>
        <div className={styles.field}>
          ...
          <input id="su-name" type="text" className={styles.input} placeholder="Jane Smith"
            value={form.fullName} onChange={e => update('fullName', e.target.value)} autoComplete="name" />
        </div>
        <div className={styles.field}>
          <label htmlFor="su-company" className={styles.label}>Company Name</label>
          <input id="su-company" type="text" className={styles.input} placeholder="Acme Corp"
            value={form.companyName} onChange={e => update('companyName', e.target.value)} autoComplete="organization" />
        </div>
      </div>

      <div className={styles.fieldFull}>
        <label htmlFor="su-email" className={styles.label}>Email</label>
        <input id="su-email" type="email" className={styles.input} placeholder="you@company.com"
      ...
      <div className={styles.row}>
        <div className={styles.field}>
          ...
          <input id="su-password" type="password" className={styles.input} placeholder="Min. 8 characters"
        ...
        <div className={styles.field}>
          ...
          <input id="su-confirm" type="password" className={styles.input} placeholder="••••••••"
            value={form.confirmPassword} onChange={e => update('confirmPassword', e.target.value)} autoComplete="new-password" />
        </div>
      </div>
  ...
  return (
    <div className={styles.page}>
      <div className={styles.wrapper}>
        ...
        {/* Header bar — attached to card, matches wireframe */}
